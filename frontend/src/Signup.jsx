...
const Signup = () => {
    ...
    return (
        <div className='flex justify-center items-center bg-gray-950 h-screen w-screen text-white'>
            <div className='flex flex-col gap-10 border-green-500 border-2 rounded-lg p-20 px-30 shadow-lg shadow-green-500 items-center'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col items-center gap-10'>
                    <div className='flex gap-5 items-center'>
                        ...
                        <input type='text' placeholder='User' name='name' value={userdata.name} onChange={handleChange} className='text-xl border-green-500 border-1 rounded-lg p-2 justify-center ' required />
                    </div>
                    <div className='flex gap-5 items-center'>
                    ...
                    <div className='flex gap-5 items-center'>
                        ...
                        <input type='password' placeholder='******' name='confirm' value={confirm} onChange={handleChange} className='text-xl border-green-500 border-1 rounded-lg p-2 justify-center' required />
                    </div>
