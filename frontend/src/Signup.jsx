            ...
            <div className='flex flex-col gap-10 border-green-500 border-2 rounded-lg p-20 px-30 shadow-lg shadow-green-500 items-center bg-gray-600'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col items-center gap-10'>
                    <div className='flex gap-5 items-center'>
                        ...
                        <input type='text' placeholder='User' name='name' value={userdata.name} onChange={handleChange} className='text-xl border-green-500 border-1 rounded-xl bg-gray-950 p-2 justify-center ' required />
                    </div>
                    <div className='flex gap-5 items-center'>
                        <p className='text-green-500 w-24 text-right italic'>Email: </p>
                        <input type='email' placeholder='User@gmail.com' name='email' value={userdata.email} onChange={handleChange} className='text-xl border-green-500 border-1 rounded-xl bg-gray-950 p-2 justify-center' required />
                    </div>
                    <div className='flex gap-5 items-center'>
                    ...
                    <div className='flex gap-5 items-center'>
                        ...
                        <input type='password' placeholder='******' name='confirm' value={confirm} onChange={handleChange} className='text-xl border-green-500 border-1 rounded-xl bg-gray-950 p-2 justify-center' required />
                    </div>
