...
const Home = () => {
    ...
    return (
        <div className="relative flex flex-col gap-20 h-full min-h-screen text-white bg-gray-950 items-center">
            <nav className="hidden lg:flex fixed top-0 left-0 w-full justify-end gap-20 p-10 z-50 bg-gray-950">
                <IoFitnessOutline className='flex size-10 text-green-500' />
            ...
            <div className='flex flex-col gap-30 my-20 w-3/4 '>
                ...
                <div className="flex flex-col leading-relaxed">
                    ...
                    <div className="flex justify-evenly w-full gap-6">
                        <ul className="flex flex-col gap-4 indent-10">
                            ...
                            <li><p>Progress tracking & real-time adjustments</p></li>
                ...
                <div className='flex flex-col leading-relaxed'>
                    ...
                    <p className=' flex flex-col gap-2 p-10 text-balance'>
                ...
                <div className='flex flex-col leading-relaxed'>
                    ...
                    <div className='flex p-10 space-x-50'>
