...
const Home = () => {
    ...
    return (
        <motion.div initial="hidden" animate="visible" className="relative flex flex-col gap-20 h-full min-h-screen text-white bg-gray-950 items-center">
            ...
            <motion.nav variants={framer.outerBoxVariant} className={`lg:flex lg:flex-row ${open ? 'flex flex-col top-10 h-screen justify-center left-1/3' : 'hidden'} items-start fixed lg:top-0 lg:left-0 w-full lg:justify-end gap-10 lg:gap-20 lg:h-30 p-10 z-2 bg-gray-950`}>
                <IoFitnessOutline className='hidden lg:flex size-10 text-green-500' />
                {user && <motion.button variants={framer.buttonOnHover} whileHover="hover" onClick={() => { navigate('/workoutplan') }}><h4 className='cursor-pointer'>Start <span className='text-green-500'>Workout</span></h4></motion.button>}
                {user && <motion.button variants={framer.buttonOnHover} whileHover="hover" onClick={() => { navigate('/updatedata') }}><h4 className='cursor-pointer'>Update <span className='text-green-500'>Details</span></h4></motion.button>}
                {user && <motion.button variants={framer.buttonOnHover} whileHover="hover" onClick={() => { navigate("/profile") }}><h4 className='cursor-pointer'>{user}</h4></motion.button>}
                {user ? (
            ...
            <div className={` ${open ? "hidden" : "flex flex-col"} lg:flex flex-col gap-30 my-20 w-3/4`}>
                <motion.div variants={framer.enterExitSideVariant} className="mt-[70px] flex flex-col">
                ...
                <motion.div variants={framer.enterExitSideVariant} className='flex flex-col leading-relaxed text-balance'>
                ...
                <motion.h4 variants={framer.enterExitSideVariant} className='flex flex-col items-center py-10'>
